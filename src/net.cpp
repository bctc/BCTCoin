...
static const char *strMainNetDNSSeed[][2] = {
    {"208.167.233.222", "208.167.233.222"},
	{"76.74.178.182", "76.74.178.182"},
	{"69.90.132.171", "69.90.132.171"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BctCoin is probably already running."), addrBind.ToString().c_str());
        else
